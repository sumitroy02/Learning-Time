...
.afternav {
    width: 100%;
    height: 900px;
    background-image: url(allimages/backimagefirstone.jpg);
...
.thirdsection {
    ...
    gap: 6rem;
    background-color: white;
    background-image: url(allimages/backimagesecondone.png);
    ...
    <main class="main1">
        <div class="background">
                ...
                <div class="registrationdiv">
                    ...
                    <div class="regi-sibling-div1">
                        ...
                        <div class="regi-sibling-div">
                          <img class="kid" src="allimages/kid1.png" alt="">
                          <img class="hat" src="allimages/hat.png" alt="">
                          <img class="book" src="allimages/book.png" alt="">
                          <img class="planet1" src="allimages/galaxy1.png" alt="">
                          <img class="rocket1" src="allimages/rocket3.png" alt="">
                          <img class="laptop" src="allimages/laptop.png" alt="">
                        </div> 
                    </div>
            ...
            <div class="box">
                <div class="box1">
                    <div class="box2"> 
                        <div class="wrap"><img src="allimages/banner1.jpg" alt=""></div>
                        <div class="wrap"><img src="allimages/banner2.jpg" alt=""></div>
                        <div class="wrap"><img src="allimages/banner3.jpg" alt=""></div>
                    </div>
                </div>
            </div>
            ...
            <div class="thirdsection">
                ...
                <div class="course-sec-div">
                    <div class="courses">
                        <img class="courseimg gkimg" src="allimages/gk.png" alt="error">
                        General Knowledge 
                    ...
                    <div class="courses">
                        <img class="courseimg enimg" src="allimages/en.png" alt="error">English Speaking<br>&<br>Learning 
                        <div class="viewmorebtn">
                            <div class="viewmorebtn1"> 
                                Start Learning
                            </div> 
                    ...
                    <div class="courses"><img class="courseimg moralimg" src="allimages/moraledu.png" alt="error">Moral Education  <div class="viewmorebtn">
                            <div class="viewmorebtn1"> 
                                Start Learning
                            </div> 
                            <div class="viewmorebtn2"></div>
                ...
                <div class="course-sec-div">
                    <div class="courses"><img class="courseimg onlineimg" src="allimages/online-teaching.png" alt="error">Classes 1-10  <div class="viewmorebtn">
                            <div class="viewmorebtn1"> 
                                Start Learning
                            </div> 
                            <div class="viewmorebtn2"></div>
                        </div></div>
                    <div class="courses"><img class="courseimg heighschoolstudyimg" src="allimages/11-12class.png" alt="error">Classes 11-12  <div class="viewmorebtn">
                            <div class="viewmorebtn1"> 
                                Start Learning
                            </div> 
                            <div class="viewmorebtn2"></div>
                        </div></div>
                    <div class="courses"><img class="courseimg Competitiveimg" src="allimages/competitive.png" alt="error">Competitive Exams  <div class="viewmorebtn">
                            <div class="viewmorebtn1"> 
                                Start Learning
                            </div> 
                            <div class="viewmorebtn2"></div>
        ...
        <div class="background4">
            <div class="aboutdiv">
                <div class="aboutimgdiv">
                    ...
                    <img class="student" src="allimages/student.jpg" alt="">
                    <img class="planet" src="allimages/planet.png" alt="">
                    <img class="stetho" src="allimages/stetho.png" alt="">
                    <img class="telescope" src="allimages/telescope.png" alt="">
                    <img class="law" src="allimages/law.png" alt="">
                    <img class="flask" src="allimages/flask.png" alt="">
               ...
               <div class="aboutcontentdiv">
                    ...
                    <div class="flex-live" >
                        <div class="flex-liveimg"><img class="fleximg" src="allimages/fleximg.png" alt=""></div>
                    ...
                    <div class="flex-live">
                        <div class="flex-liveimg"><img class="liveimg" src="allimages/liveimg.png" alt=""></div>
                        <div class="flex-live-content">
        ...
        <div class="background5">
            ...
            <div class="wrapper">
               ...
               <ul class="carousel">
                  <li class="card">
                      <div class="img"><img src="allimages/avatar1.png" alt="" draggable="false"> </div>
                      <h2 style="color:rgb(255, 255, 255); font-weight:bold;">Nishant Chaturvedi</h2>
                      <span>Lorem ipsum dolor sit amet consectetur.</span>
                  </li>
                  <li class="card">
                      <div class="img"><img src="allimages/avatar2.png" alt="" draggable="false"> </div>
                      <h2 style="color: rgb(255, 255, 255); font-weight:bold;">Sudhir Sharma</h2>
                      <span>Lorem ipsum dolor sit amet.</span>
                  </li>
                  <li class="card">
                      <div class="img"><img src="allimages/avatar4.png" alt="" draggable="false"> </div>
                      <h2 style="color:rgb(255, 255, 255); font-weight:bold;">Sidhant Agarwal</h2>
                      <span>Lorem ipsum dolor sit amet consectetur.</span>
                  </li>
                  <li class="card">
                      <div class="img"><img src="allimages/avatar3.png" alt="" draggable="false"> </div>
            ...
            <div class="whydiv">
                ...
                <div data-aos="fade-down-left" class="reasondiv">
                    <div class="reason-img-div">
                          <img class="reasonimg reasonimg1" src="allimages/reason1expert.png" alt="error">
                    </div>
                ...
                <div data-aos="fade-down-right" class="reasondiv">
                    ...
                    <div class="reason-img-div">
                         <img class="reasonimg reasonimg2" src="allimages/reason2interactive.png" alt="error">
                    </div>
                </div>

                <div data-aos="fade-down-left" class="reasondiv">
                    <div class="reason-img-div">
                         <img class="reasonimg reasonimg3" src="allimages/reason3certified.png" alt="error">
                    </div>
                    <div class="reason-content-div">
                ...
                <div data-aos="fade-down-right" class="reasondiv">
                    ...
                    <div class="reason-img-div">
                        <img class="reasonimg reasonimg4" src="allimages/reason4.png" alt="error">
                    </div>
                </div>
            </div>
        </div>
